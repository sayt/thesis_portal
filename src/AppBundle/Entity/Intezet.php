...
class Intezet
{
     ...
     * Add intezetRole
     *
     * @param \AppBundle\Entity\Intezmeny\Role $intezetRole
     * @return Intezet
     */
    public function addIntezetRole(\AppBundle\Entity\Intezmeny\Role $intezetRole)
    {
     ...
     * @param \AppBundle\Entity\Intezmeny\Role $intezetRole
     */
    public function removeIntezetRole(\AppBundle\Entity\Intezmeny\Role $intezetRole)
    {
